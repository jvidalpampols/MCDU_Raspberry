...
void draw_mcdu_window(WINDOW* win, int row, int col)
{
    ...
    mvwprintw(win, 13, 1, "123456789012345678901234"); //Scratchpad
...
int main()
{
    ...
    // if (row < MCDU_ROWS + 2 || col < MCDU_COLS + 2) {
    //     endwin();
    //     fprintf(stderr, "ERROR: Tamaño insuficiente del terminal (%d x %d). Usa fullscreen o ajusta la fuente.\n", col, row);
    //     return 1;
    // }

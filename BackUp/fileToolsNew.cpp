...
// vector<string> strComds;//Here is: vector<string> strCmdsIndexIndex
...
// bool getPageOld(string pageName)
// {
//     // into allPages[] vector<string>, find out a line that contains:
//     // PAGE=PAGENAME.
//     // Set indexStart
...
// bool getCol(string strLine) //returns a true if found #3NN//the #NN, is stored into global strTemp
// {
//     bool foundStart = false;
//     bool foundEnd = false;
//     size_t offsetStart = 0;
...
//         {
//             offsetStart = i;
//             offsetStart ++; //To skip '#   xxxxx #nn,    yyyyy
//             foundStart = true;
//         }
...
//             if(isNumber(strTemp))
//             {
//             //textColPosition = secureConvert(strTemp);
//             textColPosition = stoi(strTemp); //store value
//             }
...
//         if((offsetStart > 0) && (offsetEnd > 0))
//         {
//             strTemp = strLine.substr(offsetStart, (offsetEnd-offsetStart));
//             cleanString(strTemp);
//             if(isNumber(strTemp))
//             {
//             //textColPosition = secureConvert(strTemp);
